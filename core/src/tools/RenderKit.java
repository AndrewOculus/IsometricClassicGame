...
public class RenderKit
{
	...
	private static void charAnimationInit()
	{
		if(charAnimation==null || charAtlas==null || chatAnimAtlas==null)
		{
			...
			charAtlas = new Texture(Gdx.files.internal("HumanMaleSpritePageA.png"));
	...
	public static Sprite getAidSprite()
	{
		if(aidSprite == null)
		{
			Texture texture = new Texture(Gdx.files.classpath("aid.PNG"));
	...
	public static Sprite getPointerSprite()
	{
		...
		{
			Texture texture = new Texture(Gdx.files.classpath("pointer.PNG"));
			...
			//pointerSprite.setCenter(-pointerSprite.getWidth(), -pointerSprite.getWidth());
	...
	public static Sprite getTreeSprite() {
		if(treeSprite == null)
		{
			Texture texture = new Texture(Gdx.files.classpath("tree_1.png"));
